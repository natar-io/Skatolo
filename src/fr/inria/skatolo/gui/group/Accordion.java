 ...
 * @example controllers/skatoloaccordion
 */
@SuppressWarnings("rawtypes") public class Accordion extends ControlGroup<Accordion> {
	...
	/**
	 * Removes a ControlGroup from the accordion AND from skatolo remove(ControllerInterface
	 ...
	 * 
	 * @see skatolo.Accordion#removeItem(ControlGroup)
	...
	/**
	 * Removes a ControlGroup from the accordion and puts it back into the default tab of skatolo.
	 * if you dont have access to a ControlGroup via a variable, use
	 * skatolo.group("theNameOfTheGroup") which will return a
	 * 
	 * @return Accordion
	 */
	public Accordion removeItem(ControlGroup<?> theGroup) {
		...
		theGroup.moveTo(skatolo.controlWindow);
		updateItems();
		return this;
	}
