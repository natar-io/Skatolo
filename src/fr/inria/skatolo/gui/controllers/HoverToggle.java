 ...
 */
public class HoverToggle extends Controller<HoverToggle> {
     ...
     * @param theName
     */
    public HoverToggle(Skatolo theskatolo, String theName) {
     ...
     * @param theHeight int
     */
    public HoverToggle(Skatolo theskatolo, Tab theParent, String theName, float theValue, float theX, float theY, int theWidth, int theHeight) {
...
//		isActive = false;
    ...
    /**
     * Not used in Hovering {@inheritDoc}
     */
     ...
     */
    @Override
    public HoverToggle setValue(float theValue) {
        if (theValue == 0) {
            setState(false);
        } else {
            setState(true);
     ...
     * @param theValue
     */
    public HoverToggle setValue(boolean theValue) {
     ...
     */
    public HoverToggle setState(boolean theFlag) {
        isOn = theFlag;
    ...
    /**
     * set the visual mode of a Toggle. use setMode(skatolo.DEFAULT) or
     * setMode(skatolo.SWITCH)
     *
     * @param theMode
     */
    public HoverToggle setMode(int theMode) {
     ...
     */
    @Override
    public HoverToggle updateDisplayMode(int theState) {
    ...
    class ToggleView implements ControllerView<HoverToggle> {
    ...
    class ToggleImageView implements ControllerView<HoverToggle> {
    ...
    class ToggleSwitchView implements ControllerView<HoverToggle> {
