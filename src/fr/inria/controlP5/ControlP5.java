 ...
 * The ControlP5 class, the core of controlP5.
 * </p>
 * <p>
...
public class ControlP5 extends ControlP5Base {
    ...
    public static CColor DEFAULT_COLOR = new CColor(CP5BLUE);
     ...
     * can be enabled using controlP5.enableShortcuts();
     *
     * @see #enableShortcuts()
     */
    ...
    public ControlP5(final PApplet theParent, final Object objForIntrospection) {
        this.papplet = theParent;
        this.objectForIntrospection = objForIntrospection;
        init();
    }

    public ControlP5(final PApplet theParent, final Object objForIntrospection, PFont thePFont) {
        papplet = theParent;
        this.objectForIntrospection = objForIntrospection;
        init();
        setFont(thePFont);
    ...
    public ControlP5(final PApplet theParent, final Object objForIntrospection, ControlFont theControlFont) {
        papplet = theParent;
        this.objectForIntrospection = objForIntrospection;
        init();
        setFont(theControlFont);
    ...
    /**
     * @exclude @see controlP5.ControlP5#getAll(Class)
     * @return List<ControllerInterface>
     */
    ...
    /**
     * cp5.begin() and cp5.end() are mechanisms to auto-layout controllers, see
     * the ControlP5beginEnd example.
     */
