 ...
 */
public class HoverKnob extends Controller<HoverKnob> {
     ...
     * @param theName
     */
    public HoverKnob(Skatolo theskatolo, String theName) {
     ...
     * @exclude
     */
    public HoverKnob(Skatolo theskatolo, ControllerGroup<?> theParent, String theName, float theMin, float theMax, float theDefaultValue, int theX, int theY, int theWidth) {
    ...
    @Override
    public HoverKnob setSize(int theWidth, int theHeight) {
        return setRadius(theWidth / 2);
    }

    public HoverKnob setRadius(float theValue) {
        _myRadius = theValue;
     ...
     */
    public HoverKnob setStartAngle(float theAngle) {
        startAngle = theAngle;
     ...
     * PI + HALF_PI
     */
    public HoverKnob setAngleRange(float theRange) {
        angleRange = theRange;
        setInternalValue(modifiedValue);
        return this;
    }
    ...
    public HoverKnob setShowAngleRange(boolean theValue) {
     ...
     * @return Knob
     */
    public HoverKnob setDragDirection(int theValue) {
     ...
     */
    public HoverKnob setResolution(float theValue) {
        resolution = theValue;
        return this;
    }
    ...
    public HoverKnob setNumberOfTickMarks(int theNumber) {
    ...
    public HoverKnob showTickMarks() {
        isShowTickMarks = true;
        return this;
    }

    public HoverKnob hideTickMarks() {
    ...
    public HoverKnob snapToTickMarks(boolean theFlag) {
        isSnapToTickMarks = theFlag;
        update();
        return this;
    }

    public HoverKnob setTickMarkLength(int theLength) {
    ...
    public HoverKnob setTickMarkWeight(float theWeight) {
    ...
    public HoverKnob setConstrained(boolean theValue) {
     ...
     */
    @Override
    public HoverKnob updateInternalEvents(PApplet theApplet) {

        // Move it once mouse is pressed.
    ...
    protected void onEnter() {
        System.out.println("OnEnter Knob");
        isActive = true;
        updateValue();
    }
    ...
    @Override
    public HoverKnob setMin(float theValue) {
        _myMin = theValue;
        return this;
    }

    @Override
    public HoverKnob setMax(float theValue) {
        _myMax = theValue;
        return this;
    }

    public HoverKnob setRange(float theMin, float theMax) {
        setMin(theMin);
        setMax(theMax);
        update();
        return this;
    ...
    @Override
    public HoverKnob setValue(float theValue) {
     ...
     * @return Knob
     */
    public HoverKnob setScrollSensitivity(float theValue) {
     ...
     */
    public HoverKnob scrolled(int theRotationValue) {
        float f = getValue();
     ...
     */
    @Override
    public HoverKnob update() {
        setValue(_myValue);
        return this;
    }

    /**
     * set the display style of a knob. takes parameters Knob.LINE, Knob.ELLIPSE
     * or Knob.ARC. default style is Knob.LINE
     *
     * @param theStyle use Knob.LINE, Knob.ELLIPSE or Knob.ARC
     * @return Knob
     */
    public HoverKnob setViewStyle(int theStyle) {
        viewStyle = theStyle;
        return this;
    }
     ...
     */
    @Override
    public HoverKnob updateDisplayMode(int theMode) {
    ...
    class KnobView implements ControllerView<HoverKnob> {

        public void display(PGraphics graphics, HoverKnob theController) {
     ...
     */
    @Deprecated
    public HoverKnob setOffsetAngle(float theValue) {
     ...
     */
    @Deprecated
    public HoverKnob setDisplayStyle(int theStyle) {
        viewStyle = theStyle;
        return this;
    }
     ...
     */
    @Deprecated
    public HoverKnob setSensitivity(float theValue) {
        scrollSensitivity = theValue;
        return this;
    }
     ...
     */
    @Deprecated
    public HoverKnob showTickMarks(boolean theFlag) {
