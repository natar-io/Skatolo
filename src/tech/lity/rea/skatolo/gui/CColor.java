...
@SuppressWarnings("serial") public class CColor implements Serializable {
	...
	private final int maskR = 0xff00ffff;
	private final int maskG = 0xffff00ff;
	private final int maskB = 0xffffff00;
	...
	public CColor setAlpha(int theAlpha) {
		System.out.println("skatolo.CColor.setAlpha: setting alpha values disabled for this version of skatolo.");
		return this;
	}
