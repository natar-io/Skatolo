...
void setup() {
  ...
  skatolo.addDropdownList("drop")
     .setPosition(300, 30)
     .setWidth(200)
     .addItems(drops)
     ;
  
  skatolo.addListBox("list")
     .setPosition(520, 30)
     .setSize(150,200)
     .addItems(drops)
     ;
     
  skatolo.addTextarea("area")
     .setPosition(300, 150)
     .setSize(200,100)
     .setLineHeight(10)
...
// skatolo by using java.awt.event.MouseWheelListener and 
// java.awt.event.MouseWheelEvent

void addMouseWheelListener() {
  frame.addMouseWheelListener(new java.awt.event.MouseWheelListener() {
    public void mouseWheelMoved(java.awt.event.MouseWheelEvent e) {
      skatolo.setMouseWheelRotation(e.getWheelRotation());
    }
  }
  );
}
