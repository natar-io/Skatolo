...
void setup() {
  ...
  skatolo.addButton("clear", 0, 20, 200, 70, 20);
  skatolo.addButton("submit", 0, 310, 200, 60, 20);
  skatolo.addButton("performTextfieldActions", 0, 20, 100, 150, 20);
  skatolo.addToggle("toggleAutoClear", true, 180, 100, 90, 20).setCaptionLabel("Auto Clear");
  skatolo.addToggle("toggleKeepFocus", true, 280, 100, 90, 20).setCaptionLabel("Keep Focus");
