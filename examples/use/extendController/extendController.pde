 ...
 * 2 parameter (skatolo instance, name)  
 *
 ...
 * as default skatolo controllers.
 *  
...
void setup() {
  ...
  //   
  Group g1 = skatolo.addGroup("a").setPosition(0,100).setWidth(180);
  Group g2 = skatolo.addGroup("b").setPosition(0,10).setWidth(180);
  g2.moveTo(g1);
  
  // create 2 custom Controllers from class MyButton
  // MyButton extends Controller and inherits all methods accordingly.
  new MyButton(skatolo, "b1").setPosition(0, 0).setSize(180, 200).moveTo(g2);
  new MyButton(skatolo, "b2").setPosition(205, 15).setSize(180, 200);
...
class MyButton extends Controller<MyButton> {
  ...
  MyButton(Skatolo skatolo, String theName) {
    super(skatolo, theName);
